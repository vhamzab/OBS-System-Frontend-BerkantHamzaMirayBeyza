      ...
      {activeSession ? (
        ...
        <div className="card">
          ...
          <div className="p-6 rounded-xl bg-slate-800/50 text-center">
            <h4 className="font-semibold mb-4">Yedek Yoklama Kodu</h4>
            <div className="inline-block px-6 py-3 rounded-lg bg-white text-slate-900 font-mono text-2xl font-bold">
              {activeSession.qrCode}
            </div>
            <p className="text-sm text-slate-400 mt-3">
              GPS sorunu yaşayan öğrenciler bu kodu kullanabilir
            </p>
          </div>
        </div>
      ) : (
